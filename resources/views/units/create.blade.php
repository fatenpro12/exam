                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('unit.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="unit_name" type="text" value="{{old('unit_name')}}" class="form-control @error('unit_name') is-invalid @enderror" name="unit_name" required autocomplete="name" autofocus>
